          ...
          <div className="text-left">
            ...
            <FadeIn delay={100}>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight ">
                MEAN Stack developer Portfolio
              </h1>
            </FadeIn>
            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-137.5 mb-8">
                Building modern, scalable Application with React,Javascript and cutting-edge technologies.Transforming ideas into exceptional digital expereiences
              </p>
